const a=[{id:"basics",title:"프레젠테이션 기초",icon:"1",description:"프레젠테이션의 기본 개념과 기획 방법을 배웁니다",topics:[{id:"what-is-presentation",title:"프레젠테이션이란?",sections:[{title:"프레젠테이션의 정의",content:`프레젠테이션(Presentation)은 특정 청중에게 정보, 아이디어, 제안 등을 효과적으로 전달하는 커뮤니케이션 활동입니다.
...
- 슬라이드 가장자리에 최소 10% 여백
- 요소 간 충분한 간격
- 텍스트가 적을수록 임팩트 증가`},{title:"색상 이론과 활용",content:`### 60-30-10 색상 규칙
...
- **Color Hunt** — 트렌디한 팔레트`},{title:"타이포그래피",content:`### 폰트 크기 계층 구조
...
4. **한 줄 최대** 10~15단어
5. **왼쪽 정렬**이 가독성 최고
6. **대문자 전체 사용** 지양 (영문)`},{title:"이미지와 아이콘 활용",content:`### 이미지 사용 Do / Don't
...
</div>`}]}]},{id:"speech",title:"스피치와 전달력",icon:"3",description:"목소리, 제스처, 시선 처리 등 발표 전달력을 향상시킵니다",topics:[{id:"voice-techniques",title:"음성 활용법",sections:[{title:"발성과 호흡",content:`### 복식호흡 연습
...
1분 전: 미소 + 물 한 모금
시작:   청중에게 인사, 시작
\`\`\``}]}]},{id:"data-viz",title:"데이터 시각화",icon:"4",description:"데이터를 효과적으로 시각화하여 설득력 있는 슬라이드를 만듭니다",topics:[{id:"chart-selection",title:"차트 유형 선택",sections:[{title:"목적별 차트 선택 가이드",content:`### 주요 차트 유형 한눈에 보기
...
> **절대 피할 것**: 3D 차트, 장식적 효과, 불필요한 범례`},{title:"차트 디자인 원칙",content:`### 나쁜 차트 vs 좋은 차트
...
- **일반 데이터**: 회색 또는 연한 색
- **비교 대상**: 보조 컬러 1개
- **배경**: 흰색 또는 아주 연한 회색`}]}]},{id:"storytelling",title:"스토리텔링",icon:"5",description:"청중을 사로잡는 스토리텔링 기법을 배웁니다",topics:[{id:"storytelling-basics",title:"스토리텔링 기법",sections:[{title:"프레젠테이션 스토리텔링",content:`### 왜 스토리텔링인가?
...
</div>`}]}]},{id:"english-presentation",title:"영문 프레젠테이션",icon:"6",description:"영어로 프레젠테이션을 진행하는 핵심 노하우를 전달합니다",topics:[{id:"english-basics",title:"영문 발표 기본 표현",sections:[{title:"오프닝 표현",content:`### Opening Expressions
...
5. **필러 최소화** - "um", "uh" 대신 멈춤(pause)`}]}]}],t=s=>a.find(d=>d.id===s),l=(s,d)=>{const i=t(s);return i?i.topics.find(e=>e.id===d):null};export{l as a,t as g,a as l};
