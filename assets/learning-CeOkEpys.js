const e=[{id:"basics",title:"프레젠테이션 기초",icon:"1",description:"프레젠테이션의 기본 개념과 기획 방법을 배웁니다",topics:[{id:"what-is-presentation",title:"프레젠테이션이란?",sections:[{title:"프레젠테이션의 정의",content:`프레젠테이션(Presentation)은 특정 청중에게 정보, 아이디어, 제안 등을 효과적으로 전달하는 커뮤니케이션 활동입니다.
...
5. **필러 최소화** - "um", "uh" 대신 멈춤(pause)`}]}]}],c=d=>e.find(i=>i.id===d),t=(d,i)=>{const s=c(d);return s?s.topics.find(a=>a.id===i):null};export{t as a,c as g,e as l};
